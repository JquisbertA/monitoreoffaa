  ...
  <div>
    <div class="page-title">
      <div class="title_left">
        <h3>Gestión Empresa Servicios</h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2>Lista Empresas de Servicios </h2>
            <ul class="nav navbar-right panel_toolbox">
              <button type="submit" class="btn btn-success btn-sm" style="vertical-align: top; padding: 5px 50px;" v-on:click="AbrirModal()"><i class="fa fa-plus-circle"></i> Agregar modo de pago</button>
            </ul>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div class="col-md-4 col-sm-4  form-group pull-right ">
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Ingresar datos">
              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <tbody>
                  <tr class="even pointer">
                    ...
                    <td class=" ">ELFEC </td>
                    <td class=" ">EMPRESA DE LUZ Y FUERZA ELECTRICA CBBA </td>
                    <td class=" ">E01 </td>
